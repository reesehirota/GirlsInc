...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    #need to bunch them together under one Western Mass tab------how to do this
    ...
    menuItem("Maps", icon = icon("map"), tabName = "maps", badgeLabel = "interactive", badgeColor = "light-blue"),
    # tab: sources 
...
body <- dashboardBody(
  tabItems(
    ...
    tabItem(tabName = "charts", h2("lets put charts here")),
    tabItem(tabName = "maps", h2("lets put maps here :)")),
    tabItem(tabName = "data", h2("Sources for data used to create charts and maps"))
  )
)
```
